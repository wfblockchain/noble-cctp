...
var (
	pattern_Query_Roles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "roles"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Attester_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"cctp", "attesters", "attester"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Attesters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "attesters"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PerMessageBurnLimit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"cctp", "per_message_burn_limits", "denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PerMessageBurnLimits_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "per_message_burn_limits"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BurningAndMintingPaused_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "burning_and_minting_paused"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SendingAndReceivingMessagesPaused_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "sending_and_receiving_messages_paused"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_MaxMessageBodySize_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "max_message_body_size"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_NextAvailableNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "next_available_nonce"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_SignatureThreshold_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "signature_threshold"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TokenPair_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"cctp", "token_pairs", "remote_domain", "remote_token"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TokenPairs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "token_pairs"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_UsedNonce_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"cctp", "used_nonces", "source_domain", "nonce"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_UsedNonces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "used_nonces"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RemoteTokenMessenger_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"cctp", "remote_token_messengers", "domain_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_RemoteTokenMessengers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "remote_token_messengers"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_BurnMessageVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "burn_message_version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_LocalMessageVersion_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "local_message_version"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_LocalDomain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"cctp", "local_domain"}, "", runtime.AssumeColonVerbOpt(true)))
)
